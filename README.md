...
Microserviço criado para realizar o envio de e‑mails de forma independente, seguindo princípios (Clean Architecture). O serviço pode ser usado por aplicações front‑end ou outros microserviços para disparar e-mails por exemplo, confirmações, notificações ou reset de senha.
