...
Microserviço criado para realizar o envio de e‑mails de forma independente, seguindo princípios (Clean Architecture). O serviço pode ser usado por aplicações front‑end ou outros microserviços para disparar e-mails como confirmações, notificações ou reset de senha.
